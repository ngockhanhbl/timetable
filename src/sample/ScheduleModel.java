...
public class ScheduleModel {
    ...
    public ScheduleModel(int id, SubjectModel subjectId, String classroom, String description, LocalDate date, int startAtHour, int startAtMinute, int endAtHour, int endAtMinute) {
        this.id = id;
        this.subjectId = subjectId;
        this.classroom = classroom;
        this.description = description;
